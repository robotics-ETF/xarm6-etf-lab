...
def generate_launch_description():
    ...
    sim_dynamic_object_segmentation_node = Node(
        package='perception_etflab',
        executable='sim_dynamic_object_segmentation',
        name='sim_dynamic_object_segmentation',
        parameters=[
    ...
    return LaunchDescription([    
    	TimerAction(
            ...
            actions=[
                     ...
                     sim_dynamic_object_segmentation_node
                    ]
        ),
		robot_gazebo_launch,
        # TimerAction(
