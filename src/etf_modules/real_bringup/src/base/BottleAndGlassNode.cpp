...
void real_bringup::BottleAndGlassNode::bottleAndGlassCallback()
{
    ...
    case going_home:
        ...
        xarm_client.set_servo_angle(home_angles, Robot::getMaxAngVel(), Robot::getMaxAngAcc(), 0, true, 1, -1);
    ...
    case moving_towards_glass1:
        ...
        xarm_client.set_servo_angle(current_angles, Robot::getMaxAngVel(), Robot::getMaxAngAcc(), 0, true, 1, -1);
    ...
    case pouring_water1:
        ...
        xarm_client.set_servo_angle(current_angles, 0.7*Robot::getMaxAngVel(), 0.7*Robot::getMaxAngAcc(), 0, true, 1, -1);
    ...
    case moving_towards_glass2:
        RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Moving towards the glass...");
        xarm_client.set_servo_angle(glass_angles_approach, Robot::getMaxAngVel(), Robot::getMaxAngAcc(), 0, true, 1, -1);
        xarm_client.set_servo_angle(glass_angles_pick, 0.5*Robot::getMaxAngVel(), 0.5*Robot::getMaxAngAcc(), 0, true, 1, -1);
    ...
    case moving_glass2:
        ...
        sign *= -1;
        xarm_client.set_servo_angle(glass_angles_pick, Robot::getMaxAngVel(), Robot::getMaxAngAcc(), 0, true, 1, -1);
